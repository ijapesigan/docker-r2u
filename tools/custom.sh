...
# container
TEMP_VAR="$(git ls-remote https://github.com/$GIT_HUB_USERNAME/$REPO.git $GIT_HUB_BRANCH)"
...
# github
echo "export GIT_HUB_USERNAME=$GIT_HUB_USERNAME" >> /etc/profile.d/container_init.sh
echo "export GIT_HUB_REPO=$GIT_HUB_REPO" >> /etc/profile.d/container_init.sh
echo "export GIT_HUB_BRANCH=$GIT_HUB_BRANCH" >> /etc/profile.d/container_init.sh

# docker
echo "export DOCKER_HUB_USERNAME=$DOCKER_HUB_USERNAME" >> /etc/profile.d/container_init.sh
echo "export DOCKER_HUB_CONTAINER=$DOCKER_HUB_CONTAINER" >> /etc/profile.d/container_init.sh
